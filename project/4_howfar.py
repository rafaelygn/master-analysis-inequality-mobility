...
# Main variables
cols = config["DATAPREP"]["HOW_FAR"]["SELECT_COLUMNS"]
idx = config["DATAPREP"]["HOW_FAR"]["IDX"]
enc_others = config["DATAPREP"]["HOW_FAR"]["ENCODING"]
cat = config["DATAPREP"]["HOW_FAR"]["CATEGORICAL"]
label = config["DATAPREP"]["HOW_FAR"]["LABEL"]
...
# Save datasets
X_train.to_parquet(f"{PATH_PROJECT}data/how_far/X_train.parquet")
X_test.to_parquet(f"{PATH_PROJECT}data/how_far/X_test.parquet")
y_train.to_parquet(f"{PATH_PROJECT}data/how_far/y_train.parquet")
y_test.to_parquet(f"{PATH_PROJECT}data/how_far/y_test.parquet")
